...
public class SharePictureTab extends Fragment  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imgView=view.findViewById(R.id.uploadImgView);
    ...
    private void uploadImg(){
        ...
        if(receivedImageBitmap!=null){
            ...
            if(!descText.getText().toString().equals("")) {
                try {
                    ...
                    parseObject.saveInBackground(new SaveCallback() {
                        ...
                        public void done(ParseException e) {
                            if (e == null) {
                                FancyToast.makeText(getContext(), "Saved successfully", FancyToast.LENGTH_LONG, FancyToast.SUCCESS, false);
                                imgView.setImageResource(R.drawable.placeholder);
                                descText.setHint("Please enter the image description");
                            } else {
                                FancyToast.makeText(getContext(), e.getMessage(), FancyToast.LENGTH_LONG, FancyToast.INFO, false);
                            }
                ...
                FancyToast.makeText(getContext(),"Please enter a description for the image",FancyToast.LENGTH_LONG,FancyToast.INFO,false);
            }
        }
        else {
            FancyToast.makeText(getContext(),"Please select an Image",FancyToast.LENGTH_LONG,FancyToast.INFO,false);
        }
    }
